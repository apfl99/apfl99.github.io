...
![Beacon-Chain-Validator-Lifecycle.png](../images/2023-02-06-TheMerge/Beacon-Chain-Validator-Lifecycle.png.webp) {: .align-center}
...
이후 s가 검증된 상태에서 h(t) = h(s) + 1(인접한 블록)인 t블록에 대하여 Supermajority Link가 존재한다면 s는 완결(Finalised)되었다고 정의한다.
