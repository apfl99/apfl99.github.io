...
검증자는 블록을 구축하기 위해 의사 무작위로 선택되며, 블록 제안자와 제안된 블록에 투표하는 증명자로 구성된다.
...
<div class="notice">
  ...
  <br>
  2) <a>https://media.consensys.net/state-of-ethereum-protocol-2-the-beacon-chain-c6b6a9a69129</a>
  <br>
